                ...
                <div class="shopping-cart-container">
                    <div class="row">
                                ...
                                <table class="shop_table cart-form">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="product-price">Price (Php)</th>
                                            <th class="product-quantity">Remove</th>
                                            <!-- <th class="product-subtotal">Total (Php)</th> -->
                                        </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <?php if(isset($_SESSION['cart'])){
                                        ...
                                        foreach($_SESSION['cart'] as $key=> $value){ 
                                            ...
                                            $total_product++;
                                            ?>
                                        <tr class="cart_item" style="color: white!important">
                                            ...
                                            <td class="product-price" data-title="Price">
                                                <div class="price price-contain">
                                                    <ins><span style="color: white!important" class="price-amount"><span class="currencySymbol">Php. </span><?php echo $value['pdt_price'] ?></span></ins>
                        ...
                        <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                            <div class="shpcart-subtotal-block" style="background: #D3A121!important">
                                <div class="subtotal-line ">
                                    <b class="stt-name">Subtotal <span class="sub">(<?php echo  $total_product.'Items' ?>)</span></b>
                                    <span class="stt-price">Php. <?php echo $subtotal; ?></span>
                                </div>
                                <!-- <div class="subtotal-line">
                                    <b class="stt-name">Shipping</b>
                                    <span class="stt-price">Php. 0.00</span>
                                </div>
                                <div class="tax-fee">
