                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                     ...
                     <form class="shopping-cart-form" action="#" method="POST">
                                                    ...
                                                    <td class="product-price" data-title="Price">
                                                        <?php $count=1; ?>
                                                        <div class="">
                                                            <input type="number" value="1" name="quantity" class="quantity" style="width: 65px; color: black;" id="quantity" min="1" max="10" onchange="subtotal(), totalOfAll()" >
                    ...
                    <div class="col-md-3">
                        <div class="shpcart-subtotal-block">
                            ...
                            <div class="subtotal-line " style="display: none;">
                            ...
                            <b class="stt-name">Payment <span class="sub"></span></b> 
                                <input type="text" style="border: none; width:100%;" placeholder="input bKash TXID" name="txid">
                            ...
                            <div style="margin-top: 25px;">
                            <b class="stt-name">Address <span class="sub"></span></b>  <br>
